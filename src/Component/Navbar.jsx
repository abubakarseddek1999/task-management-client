        ...
        <div className="">
            <div className="navbar shadow-lg bg-slate-700 text-white mx-w-full">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost normal-case text-xl">  <img className="w-[40px] h-[40px] rounded-full" src="https://i.postimg.cc/9Q7PVMcD/logo-ideas-page-1.png" alt="" />T.M</a>
                </div>
